               ...
               <div class="row">
                  <div class="col-lg-12">
                     <h1 class="page-header">
                        Sign up  <small>Please fill the fields below</small>
                     </h1>
                  </div>
               </div>
               <form method="post">
                  <fieldset class="col-lg-10">
                    ...
                    <div class="form-group">
                       <div class="alert alert-<?php echo ($errTyp=="success") ? "success" : $MSG_TYPE; ?>">
                          <?php echo $MSG; ?>
                       </div>
                    </div>
                    <?php } ?>
                     ...
                     <div class="form-group">
                        ...
                        <span class="text-danger"><?php echo $repeatPassError; ?></span>
                     </div>
                     <div class="submit">
                        <button class="btn btn-success" type="submit" name="btn-signup">Submit</button>
                     </div>
                  </fieldset>
               </form>
            </div>
